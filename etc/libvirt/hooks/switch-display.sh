...
VM_DISPLAY="2"    # The display shown in `ddcutil detect`
# HDMI-1
VM_INPUT="11"     # The input the VM is connected to (without 0x, but with leading zeroes, if any. See `ddcutil capabilities`)
# DisplayPort-1
