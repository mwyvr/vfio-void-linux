...
runuser $RUNAS -c "DISPLAY=$HOST_DISPLAY /usr/bin/barriers --no-tray --address $HOST_IP:24800 --name $HOST_NAME --disable-crypto --disable-client-cert-checking -c /home/$RUNAS/.config/barrier/barrier.conf"
